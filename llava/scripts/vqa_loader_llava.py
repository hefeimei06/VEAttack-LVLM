...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-folder", type=str, default="/home/datasets/vizwiz/val")
    parser.add_argument("--question-file", type=str, default="/home/datasets/vizwiz/val_questions_vqa_format.json")
    parser.add_argument("--answers-file", type=str, help="for output", default="/home/cschlarmann37/scratch.json")
